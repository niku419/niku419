    ...
    <div >
      ...
      <div className="row main flex-md-row-reverse justify-content-between top-pad">
        <div className="col-md-6 center-head">
          <img src='http://cvresumetemplate.com/maha-personal-cv-resume-html-template/assets/images/hero.png' alt="logo" />
        </div>
        <div className="col-md-6 pt-0 pt-md-5 center-head">
          <div className="align-left">
            ...
            <div className="info pt-5">
                ...
                <Button className="reference ">
                  <a href="https://github.com/niku419">
                    <FontAwesomeIcon size="2x" icon={faGithub}/>
                  </a>
                </Button>
                <Button className="reference pl-2">
                  <a href="https://linkedin.com/niku_419" className="p-1">
                    <FontAwesomeIcon size="2x" icon={faLinkedinIn}/>
                  </a>
                </Button>
                <Button className="reference pl-2">
                  <a href="https://t.me/Niku_419" className="p-1">
                    <FontAwesomeIcon size="2x" icon={faTelegramPlane}/>
                  </a>
                </Button>
                <Button className="reference pl-2">
                  <a href="https://www.facebook.com/profile.php?id=100069976086066" className="p-1">
      ...
      <Container fluid style={{height: "100vh"}} id="about" className="pt-5">
      <div className="row main justify-content-between">
      <div className="col-md-6 center-head">
          <img src='http://cvresumetemplate.com/maha-personal-cv-resume-html-template/assets/images/hero.png' alt="logo" />
        </div>
        <div className="col-md-6 center-head">
          <h1 className="heading pt-0 pt-md-5">About me</h1>
          <div>Hello! I'am Nikhil, full stack developer from India. few somw lines about me... and i am good at</div>
          ...
          <div>My CV template</div> 
        </div>
      </div>
      </Container>
      <Container fluid style={{height: "100vh"}} id="what-i-do" className="pt-5 center-head">
