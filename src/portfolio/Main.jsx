...
import {faPhoneSquare, faEnvelope, faMapMarkerAlt, faCode, faDownload, faExternalLinkAlt, faEnvelopeOpenText } from '@fortawesome/free-solid-svg-icons'
  ...
  return (
    <div >
      ...
      <Container fluid id="contact" className="d-flex justify-content-between row m-0" style={{height: "100vh"}}>
        ...
        {/* <h1 className="heading"><Badge className="p-2" variant="dark">Contact me</Badge></h1> */}
          ...
          <div className="panel total-body pb-3">
            ...
            <div className="form px-2 pt-4" >
              <form onSubmit={sendEmail}>
                ...
                <input className="p-2" placeholder='Name' type="text" name="user_name" value={name} onChange={(e) => setName(e.target.value)} required/>
                <input className="p-2" type="email" name="user_email" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} required/>
